...
@deftogether[
  (@defproc[(bindings-ref [bindings (listof binding?)]
   ...
   @defproc[(bindings-ref-id [bindings (listof binding?)]
                             [name symbol?]
                             [default (or/c #f exact-nonnegative-integer?)]) (or/c #f exact-nonnegative-integer?)]
   @defproc[(bindings-ref-integer [bindings (listof binding?)]
                                  [name symbol?]
                                  [default (or/c #f exact-integer?)]) (or/c #f exact-integer?)]
